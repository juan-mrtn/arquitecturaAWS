# happy_path_test_suite.py
# Script de prueba automatizado para el TPFI de IS2 - Camino Feliz
# Versión con solo los casos de prueba del camino feliz (CP-01 a CP-04)
...
if __name__ == "__main__":
    print("==================================================")
    print("Iniciando Suite de Pruebas para TPFI IS2 (Singleton/Proxy/Observer) - Camino Feliz")
